		...
		<dict>
			...
			<array>
				<dict>
					...
					<key>url</key>
				<string>https://vector.im/download/<?php echo $ipaPath; ?></string>
				</dict>
				<dict>
					<key>kind</key>
					...
					<false/>
					<key>url</key>
					<string>https://vector.im/download/<?php echo $iconPath; ?></string>
				</dict>
			</array>
			<key>metadata</key>
			<dict>
				...
				<key>title</key>
                <string>Vector, <?php echo $stream; ?> integration <?php echo $build; ?></string>
			</dict>
		</dict>
	</array>
</dict>
